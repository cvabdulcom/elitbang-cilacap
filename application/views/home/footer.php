  <!-- Vendor JS Files -->
  <script src="<?php echo base_url('assets/frontend/'); ?>/vendor/bootstrap/js/bootstrap.bundle.js"></script>
  ...
  <script src="<?php echo base_url('assets/frontend/'); ?>/vendor/purecounter/purecounter.js"></script>
