...
<head>
  ...
  <title>Peserta | e-Litbang Kabupaten Cilacap</title>
            ...
            <li class="dropdown user user-menu active">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo base_url('assets/backend/') ?>dist/img/KOSONG.png" class="user-image"
                  alt="User Image">
                <span class="hidden-xs"><?php echo $this->session->userdata('nama_peserta_elitbang'); ?></span>
              </a>
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-right">
                    <a href="<?php echo base_url('masuk/keluar'); ?>" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </li>
              </ul>
            </li>
